...
//go:generate gzip --force --fast --no-name ../bin/amd64 ../bin/arm64 ../bin/riscv64
...
func main() {
	run(func() (int, error) {
		...
		//nolint:noctx,gosec // No context needed in the guest system. Arbitrary
		// args supposed to be passed by user.
